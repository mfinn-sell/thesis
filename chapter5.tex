...
\begin{corollary}
Let $G$ be a finitely generated group that coarsely contains a large girth expander. Then the Baum-Connes conjecture for $G$ with coefficients in any $(Y_{3}\rtimes G)$-$C^{*}$-algebra is an isomorphism.\qed
\end{corollary}